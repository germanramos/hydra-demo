...
cd /tmp
rm ./libzmq3-3.2.2-13.1.x86_64.rpm ./hydra-3-0.x86_64.rpm ./hydra-worker-round-robin-1-0.x86_64.rpm ./hydra-worker-map-by-limit-1-0.x86_64.rpm ./hydra-worker-sort-by-number-1-0.x86_64.rpm ./hydra-worker-map-sort-1-0.x86_64.rpm
...
sudo yum remove -y hydra hydra-worker-round-robin hydra-worker-map-by-limit hydra-worker-sort-by-number hydra-worker-map-sort 
