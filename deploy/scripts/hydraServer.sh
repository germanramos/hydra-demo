...
wget https://github.com/innotech/hydra/releases/download/v3.1.2/hydra-core-3-1.x86_64.rpm
wget https://github.com/innotech/hydra-worker-round-robin/releases/download/v1.1.0/hydra-worker-round-robin-1-1.x86_64.rpm
wget https://github.com/innotech/hydra-worker-map-by-limit/releases/download/v1.1.0/hydra-worker-map-by-limit-1-1.x86_64.rpm
...
wget https://github.com/innotech/hydra-worker-map-sort/releases/download/v1.1.0/hydra-worker-map-sort-1-1.x86_64.rpm
