...
cd /tmp
rm ./libzmq3-3.2.2-13.1.x86_64.rpm ./hydra-core-3-0.x86_64.rpm ./hydra-worker-round-robin-1-0.x86_64.rpm ./hydra-worker-map-by-limit-1-0.x86_64.rpm ./hydra-worker-sort-by-number-1-0.x86_64.rpm ./hydra-worker-map-sort-1-0.x86_64.rpm
wget https://github.com/innotech/hydra/releases/download/3.0.0_alpha/libzmq3-3.2.2-13.1.x86_64.rpm
wget https://github.com/innotech/hydra/releases/download/3.0.0_alpha/hydra-core-3-0.x86_64.rpm
...
sudo yum install -y ./libzmq3-3.2.2-13.1.x86_64.rpm ./hydra-core-3-0.x86_64.rpm ./hydra-worker-round-robin-1-0.x86_64.rpm ./hydra-worker-map-by-limit-1-0.x86_64.rpm ./hydra-worker-sort-by-number-1-0.x86_64.rpm ./hydra-worker-map-sort-1-0.x86_64.rpm
